...
frappe.match_payments = {
	...
	run: function(page) {
		...
		frappe.call({
			method: 'erpnext_bank_utils.erpnext_bank_utils.page.match_payments.match_payments.get_open_sales_invoices',
			args: { },
			callback: function(r) {
				if (r.message) {
		...
		frappe.call({
			method: 'erpnext_bank_utils.erpnext_bank_utils.page.match_payments.match_payments.get_unallocated_payment_entries',
			args: { },
			callback: function(r) {
				if (r.message) {
...
function match(page) {
    ...
    try {
        ...
        try {
            ...
            // call match method 
            frappe.call({
                method: 'erpnext_bank_utils.erpnext_bank_utils.page.match_payments.match_payments.match',
                args: {
...
function auto_match(page, method="docid") {
    //try {                   
        ...
        // call match method 
        frappe.call({
            method: 'erpnext_bank_utils.erpnext_bank_utils.page.match_payments.match_payments.auto_match',
            args: {
                'method': method
            },
            callback: function(r) {
...
function submit(payment_entry, page) {
    frappe.call({
        method: 'erpnext_bank_utils.erpnext_bank_utils.page.match_payments.match_payments.submit',
        args: { 
                'payment_entry': payment_entry
            },
        callback: function(r) {
...
function submit_all(payments, page) {
    frappe.call({
        method: 'erpnext_bank_utils.erpnext_bank_utils.page.match_payments.match_payments.submit_all',
        args: { 
